# Coulson — History — Recent Activity
...
### 2026-03-09: Issue Triage #1274 — Triggered Effects

Triaged issue #1274 (triggered effects for 3 enemy abilities). Added labels `squad:barton` and `squad:hill`. Status: awaiting Anthony spec sign-off before work can begin.
